...
class EDPRmodel(Pump):
    ...
    def __init__(self, T, Na_si, Na_se, Na_di, Na_de, Na_ex, K_si, K_se, K_di, K_de, K_ex, Cl_si, Cl_se, Cl_di, Cl_de, Cl_ex, Ca_si, Ca_se, Ca_di, Ca_de, Ca_ex, X_si, X_se, X_di, X_de, X_ex, alpha, I_stim, l, O_1, O_2, C_1, C_2, Ca0_si, Ca0_di, n, h, s, c, q, z):

        Pump.__init__(self, T, Na_si, Na_se, Na_di, Na_de, Na_ex, K_si, K_se, K_di, K_de, K_ex, Cl_si, Cl_se, Cl_di, Cl_de, Cl_ex, Ca_si, Ca_se, Ca_di, Ca_de, Ca_ex, X_si, X_se, X_di, X_de, X_ex, alpha, I_stim, l, O_1, O_2, C_1, C_2)
    ...
    def dkdt(self, I_stim):
        ...
        phi_si, phi_se, phi_di, phi_de, phi_ex, phi_sm, phi_dm  = Pump.membrane_potentials(self, I_stim)
        E_Na_s, E_Na_d, E_K_s, E_K_d, E_Cl_s, E_Cl_d, E_Ca_s, E_Ca_d = Pump.reversal_potentials(self)
        dNadt_si, dNadt_se, dNadt_di, dNadt_de, dNadt_ex, dKdt_si, dKdt_se, dKdt_di, dKdt_de, dKdt_ex, dCldt_si, dCldt_se, dCldt_di, dCldt_de, dCldt_ex, dCadt_si, dCadt_se, dCadt_di, dCadt_de, dCadt_ex, dXdt_si, dXdt_se, dXdt_di, dXdt_de, dXdt_ex = Pump.dkdt(self, I_stim)
        ...
        return dNadt_si, dNadt_se, dNadt_di, dNadt_de, dNadt_ex, dKdt_si, dKdt_se, dKdt_di, dKdt_de, dKdt_ex, dCldt_si, dCldt_se, dCldt_di, dCldt_de, dCldt_ex, \
            dCadt_si, dCadt_se, dCadt_di, dCadt_de, dCadt_ex, dXdt_si, dXdt_se, dXdt_di, dXdt_de, dXdt_ex,

    def dmdt(self, I_stim):
        phi_si, phi_se, phi_di, phi_de, phi_ex, phi_sm, phi_dm  = Pump.membrane_potentials(self, I_stim)
